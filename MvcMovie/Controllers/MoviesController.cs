...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if (movie == null)
            {
               _logger.Warn($"Edit GET, id {id} not found");
                return NotFound();
            }
            _logger.Info($"Edit GET, movie {id}");
            return View(movie);
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            if (id == null)
            {
                _logger.Warn("Delete GET with null id");
                return NotFound();
            }
            ...
            if (movie == null)
            {
                _logger.Warn("Delete GET movie {id} not found", id);
                return NotFound();
            }

            _logger.Info("Delete GET for movie {id}", id);
            return View(movie);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (movie != null)
            {
                ...
                await _context.SaveChangesAsync();
                _logger.Info("Deleted movie {id}", id);
            }
